...
<body class="has-fixed-nav">
    ...
    <main class="main">
        <div class="container" style="max-width: 900px;">
            ...
            <div class="article-breadcrumb-row mb-20">
                <span>
                    <a href="/">首页</a> &gt;
                    <a href="<?php echo urlGame($error['game_id']); ?>"><?php echo h(mb_substr($error['game_title'], 0, 20)); ?></a> &gt;
                    <span style="color:var(--text-secondary);"><?php echo h(mb_substr($error['title'], 0, 30)); ?></span>
                </span>
                <a href="<?php echo urlGame($error['game_id']); ?>" class="btn btn-secondary btn-sm">返回游戏页</a>
            </div>
            ...
            <article class="card article-detail-card">
                <div class="card-body" style="padding:28px;">
                    ...
                    <div class="article-detail-meta">
                        ...
                        <?php endif; ?>
                        <span>
                            <a href="<?php echo urlGame($error['game_id']); ?>" class="detail-author-link"><?php echo h($error['game_title']); ?></a>
                        </span>
                        <span>
                            <a href="/search?type=error&category=<?php echo intval($error['category_id']); ?>" class="article-tag-sm" style="text-decoration:none;"><?php echo h($error['category_name']); ?></a>
                        </span>
                    ...
                    <div class="article-detail-actions">
                        <?php if (isUserLoggedIn()): ?>
                            <a href="/edit_error?id=<?php echo $error['id']; ?>" class="btn btn-secondary btn-sm">编辑 / 补充内容</a>
                        <?php endif; ?>
                        <a href="<?php echo urlGame($error['game_id']); ?>" class="btn btn-secondary btn-sm">返回游戏页</a>
                    </div>
                </div>
    ...
    <div id="view-counter-config" data-type="error" data-id="<?php echo $id; ?>" style="display:none;"></div>
