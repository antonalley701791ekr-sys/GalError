                    ...
                    <div class="card" style="margin-bottom:20px;">
                        ...
                        <div class="card-body">
                            ...
                            <div style="margin-top:20px;display:flex;gap:12px;flex-wrap:wrap;align-items:flex-start;">
                                <a href="article_review.php?action=approve_revision&rev_id=<?php echo $viewRevision['id']; ?>" class="btn btn-success<?php echo pd('articles','edit'); ?>"<?php echo pdAttr('articles','edit'); ?> onclick="<?php echo hasPermission('articles','edit') ? "return confirm('确定通过此修改？修改将直接应用到文章。');" : 'return false;'; ?>">通过修改</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($viewArticle['status'] === 'pending'): ?>
                                <div style="margin-top:20px;display:flex;gap:12px;flex-wrap:wrap;align-items:flex-start;">
                                    <a href="article_review.php?action=approve&id=<?php echo $viewArticle['id']; ?>" class="btn btn-success<?php echo pd('articles','edit'); ?>"<?php echo pdAttr('articles','edit'); ?> onclick="<?php echo hasPermission('articles','edit') ? "return confirm('确认通过该文章？');" : 'return false;'; ?>">通过</a>
                            ...
                            <div style="margin-top:<?php echo $viewArticle['status'] === 'pending' ? '12px' : '20px'; ?>;">
                                <a href="?action=delete&id=<?php echo $viewArticle['id']; ?>" class="btn btn-danger<?php echo pd('articles','delete'); ?>"<?php echo pdAttr('articles','delete'); ?> onclick="<?php echo hasPermission('articles','delete') ? "return confirm('确定要删除这篇文章吗？');" : 'return false;'; ?>">删除</a>
                            </div>
                                                    ...
                                                    <td>
                                                        <div class="action-btns">
                                                            ...
                                                            <?php if ($rev['status'] === 'pending'): ?>
                                                                <a href="?action=approve_revision&rev_id=<?php echo $rev['id']; ?>" class="btn btn-success btn-sm<?php echo pd('articles','edit'); ?>"<?php echo pdAttr('articles','edit'); ?> onclick="<?php echo hasPermission('articles','edit') ? "return confirm('确定通过此修改？');" : 'return false;'; ?>">通过</a>
                                        ...
                                        <tbody>
                                            <?php foreach ($articles as $art): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action-btns">
                                                            <a href="?action=view&id=<?php echo $art['id']; ?>" class="btn btn-sm">查看</a>
                                                            <?php if ($art['status'] === 'pending'): ?>
                                                                <a href="?action=approve&id=<?php echo $art['id']; ?>" class="btn btn-success btn-sm<?php echo pd('articles','edit'); ?>"<?php echo pdAttr('articles','edit'); ?> onclick="<?php echo hasPermission('articles','edit') ? "return confirm('确认通过？');" : 'return false;'; ?>">通过</a>
                                                            ...
                                                            <?php endif; ?>
                                                            <a href="?action=delete&id=<?php echo $art['id']; ?>" class="btn btn-danger btn-sm<?php echo pd('articles','delete'); ?>"<?php echo pdAttr('articles','delete'); ?> onclick="<?php echo hasPermission('articles','delete') ? "return confirm('确定删除？');" : 'return false;'; ?>">删除</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
