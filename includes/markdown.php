...
class ParsedownToc extends Parsedown
{
    ...
    protected function inlineImage($Excerpt)
    {
        ...
        if ($Inline !== null && isset($Inline['element']['attributes']['src'])) {
            ...
            if ($src !== '') {
                $Inline['element']['attributes']['src'] = markdown_proxy_image_url($src);
            }
...
function md_to_html($markdown) {
    ...
    $normalizedMarkdown = markdown_normalize_tables(markdown_normalize_plain_image_urls($normalizedMarkdown));
